      ...
      <div className=" flex border border-violet-500 rounded-md">
        ...
        <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
          <div className="flex items-center justify-between">
            <span className=" bg-violet-200 text-violet-500 border border-violet-500 px-2 rounded-md">
              featured
            </span>
          ...
          <div className="space-y-2 mt-4 h-full">
            ...
            <p className="">Dr Elizabeth McNaught</p>
            <div className="flex">
              <svg
                viewBox="0 0 20 20"
                fill="currentColor"
            ...
            <p className="text-violet-500 text-xl font-bold ">BDT 14</p>
          </div>
        </div>
      </div>
    </div>
